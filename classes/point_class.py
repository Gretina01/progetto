...
# Import math library to use radians, cos, sin, asin, sqrt
...
class Point():
    ...
    def set_latitude(self, latitude):
        ...
        try:
            ...
            print(f"Cannot setted the latitude because there was an error: {value}.")
        except TypeError as typeerr:
            print(f"Cannot setted the latitude because there was an error: {typeerr}.")
        else:
            self._lat = latitude
    ...
    def set_longitude(self, longitude):
        ...
        try:
            ...
            print(f"Cannot setted the latidue because there was an error: {value}.")
        except TypeError as typeerr:
            print(f"Cannot setted the latidue because there was an error: {typeerr}.")
        else:
            self._lon = longitude
    ...
    def get_distance_from_this_point(self, obj):
        ...
        raise ValueError("Expected obj to be an instance of Point.")
